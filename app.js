const machines = [
  ...
  {id:'g7-s22',model:'G7-S22',name:'Ultra Pec Fly / Rear Delt',pt:'Voador / voador invertido',image:'assets/images/G7-S22.png',primary:'Peitoral maior',secondary:'deltoide posterior e romboides',bio:'Permite adução horizontal dos braços no voador e abdução horizontal no voador invertido.',product:'https://world.matrixfitness.com/eng/strength/single-station/g7-s22-pectoral-fly',manual:'',video:'https://www.youtube.com/results?search_query=Matrix+G7-S22'},
  {id:'g7-s13',model:'G7-S13',name:'Ultra Converging Chest Press',pt:'Supino sentado',image:'assets/images/G7-S13.png',primary:'Peitoral maior',secondary:'tríceps e deltoide anterior',bio:'A trajetória convergente combina adução horizontal do ombro com extensão do cotovelo.',product:'https://br.matrixfitness.com/ptb/strength/single-station/g7-s13-converging-chest-press',manual:'',video:'https://www.youtube.com/results?search_query=Matrix+G7-S13'},
  {id:'mg-pl12',model:'MG-PL12',name:'Magnum Vertical Bench Press',pt:'Supino vertical',image:'assets/images/MG-PL12.png',primary:'Peitoral maior',secondary:'tríceps e deltoide anterior',bio:'Equipamento plate-loaded para pressão horizontal/vertical com apoio das costas.',product:'https://world.matrixfitness.com/eng/strength/plate-loaded/mg-pl12-vertical-bench-press',manual:'',video:'https://www.youtube.com/results?search_query=Matrix+MG-PL12'},
  {id:'mg-pl70',model:'MG-PL70',name:'Magnum 45 Degree Leg Press',pt:'Leg press 45°',image:'assets/images/MG-PL70.png',primary:'Quadríceps e glúteos',secondary:'isquiotibiais e panturrilhas',bio:'Extensão combinada de joelhos e quadris; também usado para flexão plantar de panturrilhas.',product:'https://world.matrixfitness.com/eng/strength/plate-loaded/mg-pl70-45-degree-leg-press',manual:'',video:'https://www.youtube.com/results?search_query=Matrix+MG-PL70'},
  {id:'mg-pl62',model:'MG-PL62',name:'Magnum Smith Machine',pt:'Agachamento Smith',image:'assets/images/MG-PL62.png',primary:'Quadríceps e glúteos',secondary:'isquiotibiais e estabilizadores',bio:'A barra guiada permite agachamento com trajetória vertical controlada.',product:'https://world.matrixfitness.com/eng/strength/plate-loaded/mg-pl62-smith-machine',manual:'',video:'https://www.youtube.com/results?search_query=Matrix+MG-PL62'},
  {id:'g3-ms24',model:'G3-MS24',name:'Aura Adjustable Pulley',pt:'Polia ajustável',image:'assets/images/G3-MS24.png',primary:'Variável conforme o exercício',secondary:'tríceps, costas, ombros e braços',bio:'A polia regulável permite selecionar a altura e o vetor de força para diferentes exercícios.',product:'https://world.matrixfitness.com/eng/strength/multi-station/adjustable-pulley',manual:'',video:'https://www.youtube.com/results?search_query=Matrix+G3-MS24'},
  {id:'g7-s71',model:'G7-S71',name:'Ultra Leg Extension',pt:'Extensora sentada',image:'assets/images/G7-S71.png',primary:'Quadríceps',secondary:'reto femoral e estabilizadores do joelho',bio:'Extensão do joelho com apoio das costas e eixo alinhado ao pivô da máquina.',product:'https://world.matrixfitness.com/eng/strength/single-station/g7-s71-leg-extension',manual:'',video:'https://www.youtube.com/results?search_query=Matrix+G7-S71'},
  {id:'g3-ms52',model:'G3-MS52',name:'Aura Triceps Pressdown',pt:'Tríceps na polia',image:'assets/images/G3-MS52.png',primary:'Tríceps braquial',secondary:'estabilizadores do ombro e antebraço',bio:'Extensão do cotovelo na polia alta, com corda ou barra.',product:'https://br.matrixfitness.com/ptb/strength/multi-station/triceps-pressdown',manual:'',video:'https://www.youtube.com/results?search_query=Matrix+G3-MS52'},
  {id:'g3-s52',model:'G3-S52',name:'Aura Back Extension',pt:'Extensor lombar',image:'assets/images/G3-S52.png',primary:'Eretores da coluna',secondary:'glúteos, isquiotibiais e estabilizadores do tronco',bio:'Extensão controlada do quadril e da coluna no equipamento com apoio do tronco.',product:'https://world.matrixfitness.com/eng/strength/single-station/g3-s52-back-extension',manual:'',video:'https://www.youtube.com/results?search_query=Matrix+G3-S52'}
];
...
function card(m){return `<article class="machine" id="${m.id}" data-search="${esc([m.model,m.name,m.pt,m.primary,m.secondary].join(' ').toLowerCase())}">
  <div class="machine-visual"><img src="${m.image}" alt="Imagem técnica do equipamento ${esc(m.name)}" loading="lazy"><span class="model-tag">${m.model}</span><button class="photo-button" data-photo="${m.image}" data-caption="Imagem do equipamento · ${esc(m.model)} · abrir em tamanho maior">Ampliar imagem do equipamento ↗</button></div>
